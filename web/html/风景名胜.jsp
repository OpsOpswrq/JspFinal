...
<%
    ...
    if(request.getAttribute("paths")==null||request.getAttribute("texts")==null){
        response.sendRedirect("/feng/handleScenePicture");
    }else {
        ...
        out.write("<div id=\"div2\">\n" +
                ...
                "                <p class=\"desc\" style=\"position:absolute;left:370px;top:-230px;width: 90px;height: 30px;font-family: KaiTi\">梅岭</p>\n" +
                "            </div>\n" +
                "        </div>\n" +
                "        <div style=\"position: absolute;top:-10px;left:300px;width: 760px;height: 160px;\">\n" +
        ...
        out.write("<div id=\"div3\">\n" +
                ...
                "                <p class=\"desc\" style=\"position:absolute;left:-220px;top:-230px;width: 90px;height: 30px;font-family: KaiTi\">滕王阁</p>\n" +
                "            </div>\n" +
                "        </div>\n" +
                "        <div style=\"position: absolute;top:0px;left:0px;width: 760px;height: 160px;\">\n" +
                "            <p style=\"font-family: KaiTi;font-size: 20px;\">\n" +
                "                \n" +texts[1]+
                "            </p>\n" +
                "        </div>\n" +
        ...
        out.write("<div id=\"div4\">\n" +
                ...
                "                <p class=\"desc\" style=\"position:absolute;left:370px;top:-230px;width: 90px;height: 30px;font-family: KaiTi\">湾里</p>\n" +
                "            </div>\n" +
                "        </div>\n" +
                "        <div style=\"position: absolute;top:-10px;left:300px;width: 760px;height: 160px;\">\n" +
                "            <p style=\"font-family: KaiTi;font-size: 20px;\">\n" +
